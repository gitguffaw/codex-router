...
test("public release metadata and changelog advertise the 2.1.0 model-discovery release", () => {
  const packageJson = JSON.parse(fs.readFileSync(path.join(ROOT, "package.json"), "utf8"));
  ...
  assert.equal(marketplace.version, "2.1.0");
  ...
  assert.equal(pluginManifest.version, "2.1.0");
