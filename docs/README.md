...
This is a clean-sheet direction, not a description of code that already exists. The current implementation remains the v2.4.0 JavaScript companion runtime under `plugins/codex-router/scripts/`.
